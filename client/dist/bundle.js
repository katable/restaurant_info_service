...
var Description = function Description(_ref) {
  ...
  var expandCollapseDiv = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
/***/ "./client/src/components/DetailItem.jsx":
/*!**********************************************!*\
  !*** ./client/src/components/DetailItem.jsx ***!
  \**********************************************/
/*! exports provided: default */
...
var InfoMenu = function InfoMenu(_ref) {
  var restaurantInfo = _ref.restaurantInfo;
  var stars = restaurantInfo.stars,
...
/***/ "./client/src/components/PrivateDining.jsx":
/*!*************************************************!*\
  !*** ./client/src/components/PrivateDining.jsx ***!
  \*************************************************/
/*! exports provided: default */
...
PrivateDining.propTypes = {
  privateDining: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string
};
PrivateDining.defaultProps = {
  privateDining: ''
};
/* harmony default export */ __webpack_exports__["default"] = (PrivateDining);
...
var RestaurantDetails = function RestaurantDetails(props) {
  var restaurantInfo = props.restaurantInfo;
  var cuisine = restaurantInfo.cuisine.join(', ') || '';
  var style = restaurantInfo.style || '';
  var tags = {
    additional: restaurantInfo.tags.additional.join(', ') || ''
  };
  var hours = restaurantInfo.hours || '';
  var phone = restaurantInfo.phone || '';
  var website = restaurantInfo.website || '';
  var payment = restaurantInfo.payment.join(', ') || '';
  var dress = restaurantInfo.dress || '';
  var chef = restaurantInfo.chef || '';
  var catering = restaurantInfo.catering || '';
  var privateParty = {};
  ...
  var address = "".concat(location.street, " ").concat(location.city, ", ").concat(location.state, " ").concat(location.zip);
  var entertainment = restaurantInfo.entertainment || '';
  var specials = restaurantInfo.specials || '';
  var detailTitlesGroupLeft = ['Dining Style', 'Cuisines', 'Hours of operation', 'Phone number', 'Website', 'Payment options', 'Dress code', 'Executive chef', 'Private party facilities', 'Private party contact', 'Catering'];
  var iconsLeft = [icons.dining_style, icons.cuisine, icons.hours, icons.phone, icons.website, icons.payment, icons.dress, icons.chef, icons.private_dining, icons.contact, icons.catering];
  var detailsLeft = [style, cuisine, hours, phone, website, payment, dress, chef, privateParty.facilities, privateParty.contact, catering];
  var detailTitlesGroupRight = ['Address', 'Neighborhood', 'Cross street', 'Parking details', 'Public transit', 'Entertainment', 'Special events &amp; promotions', 'Additional'];
  var iconsRight = [icons.location, icons.neighborhood, icons.cross_street, icons.parking, icons.public_transit, icons.entertainment, icons.special_events, icons.tag];
  var detailsRight = [address, location.neighborhood, location.cross_street, location.public_transit, location.parking_details, entertainment, specials, tags.additional];
  var leftItems = detailTitlesGroupLeft.map(function (el, i) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_DetailItem_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], {
      title: el,
      icon: iconsLeft[i],
  ...
  var rightItems = detailTitlesGroupRight.map(function (el, i) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_DetailItem_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], {
      title: el,
      icon: iconsRight[i],
...
var Stars = function Stars(_ref) {
  ...
  if (stars - Math.floor(stars) > 0.25 && stars - Math.floor(stars) < 0.75) {
    ...
    for (var _i = 0; _i < 5 - Math.floor(stars) - 1; _i += 1) {
      allStars.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", {
        key: allStars.length
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
        className: _scss_base_scss__WEBPACK_IMPORTED_MODULE_2___default.a.grey,
    ...
    for (var _i2 = 0; _i2 < 5 - Math.floor(stars); _i2 += 1) {
      allStars.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", {
        key: allStars.length
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
        className: _scss_base_scss__WEBPACK_IMPORTED_MODULE_2___default.a.grey,
...
var TopTags = function TopTags(_ref) {
...
exports.locals = {
	...
	"privateDiningButton": "base__privateDiningButton___3aN_a",
